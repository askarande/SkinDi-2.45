...
def registration():
    try:
        ...
        print("Registration script launched successfully.")
    except Exception as e:
        print(f"Error launching registration script: {e}")
    root.destroy()
    ...
    with sqlite3.connect('evaluation1.db') as db:
        ...
        # Find user If there is any take proper action
         ...
         cursor.execute("CREATE TABLE IF NOT EXISTS registration"
                           "(id INTEGER NOT NULL UNIQUE, Fullname TEXT, address TEXT, username TEXT, Email TEXT, Phoneno TEXT,Gender TEXT,age TEXT , password TEXT)")
         db.commit()
         ...
         for row in result1:    
             ...
             id=str(row[0])
             print(id)
             with open(r"C:\Users\User\OneDrive\Documents\Custom Office Templates\id.txt", 'w') as f:
...
#bg_icon=ImageTk.PhotoImage(file=r"C:/Users/User/new/Skin_Disease/L.jpg")
#user_icon=ImageTk.PhotoImage(file=r"C:/Users/User/new/Skin_Disease/l1.png")
#pass_icon=ImageTk.PhotoImage(file=r"C:/Users/User/new/Skin_Disease/p1.jpg")
